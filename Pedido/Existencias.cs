...
namespace Pedido
{
    public partial class Existencias : Form
    {
        ...
        public Existencias()
        {
            ...
            label3.Text = Variablescompartidas.NombrePro;
            ...
            dataGridView1.Rows.Add("Cedis en Matriz", "0");
            dataGridView1.Rows.Add("Transito  Matriz", "0");
            dataGridView1.Rows.Add("Transito SP", "0");
            dataGridView1.Rows.Add("Transito LP", "0");
            dataGridView1.Rows.Add("Transito IGS", "0");
            dataGridView1.Rows.Add("Parque Industrial", "0");
            ...
            try
            {
                ...
                while (almacen <= 24)
                {
                    if (almacen != 2 || almacen != 6 || almacen != 7)
                    {
                        ...
                        if (almacen == 1 || almacen == 3 || almacen == 4 || almacen == 5 ||almacen==19|| almacen == 20 || almacen == 21 || almacen == 22 || almacen == 24 || almacen == 25 /*|| almacen == 7 || almacen == 8*/)
                        {
                            if (ds.Rows.Count > 0)
                            {
