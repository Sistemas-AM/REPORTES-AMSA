...
namespace Cotizacion2021
{
    ...
    public partial class CargaCotizacion : MaterialForm
    {
        ...
        {
            SqlCommand cmd = new SqlCommand(@"Select id_Documento, FolioCotizacion, FolioCot, Fecha, esLocal, codCliente, observaciones,  CRAZONSOCIAL as nombrecliente, Atencion, Solicito, notas_Internas, lista_precios
